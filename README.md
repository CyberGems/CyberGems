...
| [⚡ **CyberTray**](https://github.com/CyberGems/CyberTray) | High-performance tray launcher with active hotspots, RAM/CPU/Disk monitoring, process manager & PIN-protected file vault | ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) |
| [🛡️ **CyberWall**](https://github.com/CyberGems/CyberWall) | User-friendly Windows firewall with real-time per-app rules, powered by Windows Filtering Platform (WFP) kernel engine | ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white) |
| [📸 **CyberSnap**](https://github.com/CyberGems/CyberSnap) | Screen capture, annotation & utility suite. Vector drawing, annotation editor, high-speed OCR & screen recording | ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white) |
| [⚡ **CyberPaste**](https://github.com/CyberGems/CyberPaste) | Privacy-first clipboard history manager — text, code, images, HTML & files | ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) |
| [📝 **CyberNotes**](https://github.com/CyberGems/CyberNotes) | Privacy-focused note-taking with rich text, folders & tabs, bcrypt master password & fully local storage | ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) |
